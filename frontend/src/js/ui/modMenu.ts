...
export function setupModMenu() {
    ...
    document.getElementById('modGoldBtn')?.addEventListener('click', () => {
        ...
        updateUI();
        PoolManager.getFloatingText(state.ghostMouse.x, state.ghostMouse.y, state.infiniteGold ? "Infinite Gold AN" : "Infinite Gold AUS", "#fca311");
    ...
    document.getElementById('modLifeBtn')?.addEventListener('click', () => {
        ...
        updateUI();
        PoolManager.getFloatingText(state.ghostMouse.x, state.ghostMouse.y, state.godMode ? "God Mode AN" : "God Mode AUS", "#ff3366");
    ...
    document.getElementById('modSetWaveBtn')?.addEventListener('click', () => {
        ...
        if (input) {
            ...
            if (val >= 1) {
                ...
                updateUI();
                PoolManager.getFloatingText(state.ghostMouse.x, state.ghostMouse.y, `Welle auf ${val} gesetzt!`, '#4cc9f0');
