/*
 * @file: frontend\src\js\entities\enemies\types\basic.ts
...
export class NormalEnemy extends BaseEnemy {
    constructor(waveNumber: number) {
        ...
        this.reward = Math.floor(Config.ENEMY_REWARD_BASE * Math.pow(Config.ENEMY_REWARD_MULTIPLIER, waveNumber - 1));
        this.initHp();
    }
}
...
export class ScoutEnemy extends BaseEnemy {
    constructor(waveNumber: number) {
        ...
        this.reward = Math.floor((Config.ENEMY_REWARD_BASE * 0.8) * Math.pow(Config.ENEMY_REWARD_MULTIPLIER, waveNumber - 1));
        this.initHp();
    }
...
export class BruiserEnemy extends BaseEnemy {
    constructor(waveNumber: number) {
        ...
        this.reward = Math.floor((Config.ENEMY_REWARD_BASE * 2) * Math.pow(Config.ENEMY_REWARD_MULTIPLIER, waveNumber - 1));
        this.initHp();
    }
